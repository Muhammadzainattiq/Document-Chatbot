...
openapi_key = st.secrets["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"]
...
def main():
    ...
    with st.sidebar:
        ...
        # openai_api_key = st.text_input("OpenAI API Key", key=openapi_keshywsjwy , type="password")
